...
public class ResideMenu extends FrameLayout {
    ...
    public  static CircleImageView imageMenuPhoto;
    private String strMenuPhotoURL;
    private LinearLayout layoutLeftMenu;
    private LinearLayout layoutRightMenu;
    private View scrollViewLeftMenu;
    private View scrollViewRightMenu;
    private View scrollViewMenu;
    public static RelativeLayout menuCategory;
    public static RelativeLayout menuIns;
    public static RelativeLayout menuProfile;
    public static RelativeLayout menuFavoris;
    public static RelativeLayout menuNofications;
    public static RelativeLayout menuMessages;
    public static RelativeLayout menuAbouts;
    public static RelativeLayout menuLogout;
    public static CircleImageView menuNotiBadge;
    public static TextView txtMenuNotiBadge;
    public static CircleImageView menuMessBadge;
    public static TextView txtMenuMessBadge;
    ...
    public ResideMenu(Context context,String strMenuPhotoURL) {
        super(context);
        initViews(context,-1, -1,strMenuPhotoURL);
    }
    ...
    public ResideMenu(Context context, int customLeftMenuId,
        ...
        super(context);
        initViews(context, customLeftMenuId, customRightMenuId,null);
    }

    private void initViews(Context context, int customLeftMenuId,
                           int customRightMenuId,String strMenuPhotoURL) {
        ...
        if (customLeftMenuId >= 0) {
            ...
            imageMenuPhoto = (CircleImageView) scrollViewLeftMenu.findViewById(R.id.img_menu_photo);
            menuCategory = (RelativeLayout)scrollViewLeftMenu.findViewById(R.id.menu_category);
            menuIns = (RelativeLayout)scrollViewLeftMenu.findViewById(R.id.menu_ins);
            menuProfile = (RelativeLayout)scrollViewLeftMenu.findViewById(R.id.menu_profile);
            menuFavoris = (RelativeLayout)scrollViewLeftMenu.findViewById(R.id.menu_favoris);
            menuNofications = (RelativeLayout)scrollViewLeftMenu.findViewById(R.id.menu_notifications);
            menuNotiBadge = (CircleImageView)scrollViewLeftMenu.findViewById(R.id.menu_notibadge);
            txtMenuNotiBadge  = (TextView)scrollViewLeftMenu.findViewById(R.id.txtmenu_notibadge);

            menuMessages = (RelativeLayout)scrollViewLeftMenu.findViewById(R.id.menu_message);
            menuMessBadge = (CircleImageView)scrollViewLeftMenu.findViewById(R.id.menu_messagebadge);
            txtMenuMessBadge  = (TextView)scrollViewLeftMenu.findViewById(R.id.txtmenu_messbadge);

            menuAbouts = (RelativeLayout)scrollViewLeftMenu.findViewById(R.id.menu_about);
            menuLogout = (RelativeLayout)scrollViewLeftMenu.findViewById(R.id.menu_logout);
            Picasso.with(context)
                    .load(strMenuPhotoURL)
